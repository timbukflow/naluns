...
<body class="green">
    <section class="maincontent subpage datenschutz">
        ...
        <h4 class="gold">2.2 Rechtsgrundlagen</h4>
        <p>
        ...
        <h3 class="gold">3. Art, Umfang und Zweck</h3>
        <p>
        ...
        <h3 class="gold">4. Personendaten im Ausland</h3>
        <p>
        ...
        <h3 class="gold">5. Rechte von betroffenen Personen</h3>
        <h4 class="gold">5.1 Datenschutzrechtliche Ansprüche</h4>
        <p>
        ...
        <h4 class="gold">5.2 Recht auf Beschwerde</h4>
        <p>
        ...
        <h3 class="gold">6. Datensicherheit</h3>
        <p>
        ...
        <h3 class="gold">7. Nutzung der Website</h3>
        <h4 class="gold">7.1 Cookies</h4>
        <p>
        ...
        <h4 class="gold">7.2 Server-Logdateien</h4>
        <p>
        ...
        <h3 class="gold">8. Dienste von Dritten</h3>
        <p>
        ...
        <p>
            ...
            <a class="gold" href="https://policies.google.com/privacy?hl=de">Dienste von Google</a><br>
            <a class="gold" href="https://payrexx.com/de-ch/datenschutzerklaerung">Dienste von Payrexx AG </a><br>
        </p>
        <h4 class="gold">8.1 Digitale Infrastruktur</h4>
        <p>
        ...
        <p>
            Wir nutzen insbesondere: <br>
            <a class="gold" href="https://www.hostpoint.ch/hostpoint/kontakt-agb.html#datenschutz">Dienste von Hostpoint AG</a><br>
            <a class="gold" href="https://docs.github.com/de/site-policy/privacy-policies/github-privacy-statement">Dienste von GitHub</a><br>
        </p>
        <h4 class="gold">8.2 Schriftarten</h4>
        <p>
        ...
        <h3 class="gold">11. Schlussbestimmungen</h3>
        <p>
