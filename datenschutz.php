...
<body class="green">
    <section class="datenschutz">
        ...
        <h3>2. Begriffe und Rechtsgrundlagen</h3>
        <p>2.1 Begriffe</p>
        <p>
        ...
        <h3>4. Personendaten im Ausland</h3>
        <p>
        ...
        <h3>5. Rechte von betroffenen Personen</h3>
        ...
        <h3>9. Erweiterungen für die Website</h3>
        <p>
        ...
        <h3>10. Erfolgs- und Reichweitenmessung</h3>
        <p>
